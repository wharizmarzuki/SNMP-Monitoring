...
#### Automated Test Report (Generated by script)
```bash
cd backend
python tests/generate_test_report.py
# Report saved to: docs/testing/TEST_RESULTS.md
```

**Backend Report Locations:**
- Terminal: Immediate output
- Coverage: `backend/htmlcov/index.html`
- Automated Report: `docs/testing/TEST_RESULTS.md`
...
# If tests fail, view detailed trace:
npx playwright show-trace playwright-report/trace.zip
```

**Frontend Report Locations:**
- Terminal: Immediate output
- HTML Report: `frontend/playwright-report/index.html` (use `npx playwright show-report`)
- Screenshots: `frontend/test-results/` (for failed tests)
- Videos: `frontend/test-results/` (if enabled)
- Trace Files: `frontend/playwright-report/` (for debugging)

---

### Quick Comparison

| Feature | Backend (pytest) | Frontend (Playwright) |
|---------|-----------------|----------------------|
| **Terminal Output** | ✅ `pytest -v` | ✅ `npm run test:e2e` |
| **HTML Report** | `htmlcov/index.html` | `playwright-report/index.html` |
| **View Command** | Open in browser | `npx playwright show-report` |
| **Coverage** | ✅ `pytest-cov` | ✅ `npm run test:coverage` |
| **Interactive UI** | ❌ | ✅ `npm run test:e2e:ui` |
| **Traces/Debug** | Stack traces | ✅ Full trace viewer |
| **Screenshots** | ❌ | ✅ Auto for failures |
| **Videos** | ❌ | ✅ Configurable |
