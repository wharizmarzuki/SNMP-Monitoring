...
# OLD ENDPOINTS (DEPRECATED - Use /alerts/{alert_type} instead)

@router.put("/{ip}/alert/cpu/acknowledge", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/alert/cpu/resolve", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/alert/memory/acknowledge", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/alert/memory/resolve", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/alert/reachability/acknowledge", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/alert/reachability/resolve", response_model=schemas.AlertStateResponse, deprecated=True)
...
# OLD INTERFACE ENDPOINTS (DEPRECATED - Use /interfaces/{if_index}/alerts/{alert_type} instead)

@router.put("/{ip}/interface/{if_index}/alert/status/acknowledge", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/interface/{if_index}/alert/status/resolve", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/interface/{if_index}/alert/drops/acknowledge", response_model=schemas.AlertStateResponse, deprecated=True)
...
@router.put("/{ip}/interface/{if_index}/alert/drops/resolve", response_model=schemas.AlertStateResponse, deprecated=True)
